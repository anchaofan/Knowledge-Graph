<template>
    <div class="detail-container">
        ...
        <div class="painting-cnt">
            <div class="left-cnt">
                <img v-bind:src="painterDetail.image" class="pic" alt="pic1" />
            </div>
            <div class="right-cnt">
                <el-card class="box-card">
                    <div class="title"><i class="el-icon-reading"></i> Painter1 </div>
                    <div class="item"> <el-tag>name</el-tag> <span class="font">666 {{sname}}</span></div>
    ...
    export default {
        ...
        methods: {
          ...
          getViewInfo() {
            ...
            // this.infoDetail = this.sdata.description;
            // eslint-disable-next-line no-console
